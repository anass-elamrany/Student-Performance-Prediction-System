...
const STATUS_CONFIG = {
  'À risque': { color: 'error', icon: <ErrorIcon fontSize="small" /> },
  'Moyenne performance': { color: 'warning', icon: <WarningIcon fontSize="small" /> },
  'Bon performeur': { color: 'success', icon: <CheckCircleIcon fontSize="small" /> }
};
